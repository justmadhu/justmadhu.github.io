...
// Removed location property as requested
...
export const CAREER_HISTORY: CareerItem[] = [
  { id: 'h1', name: 'Chime', role: 'Chief Product Officer', year: 'PRESENT', icon: 'CH' },
  { id: 'h2', name: 'Notion', role: 'Chief Product Officer', year: 'PREV', icon: 'NT' },
  { id: 'h3', name: 'Robinhood', role: 'VP / Head of Product', year: 'PREV', icon: 'RH' },
  { id: 'h4', name: 'Oculus', role: 'Director', year: 'PREV', icon: 'OC' },
  { id: 'h5', name: 'Twitter', role: 'Director', year: 'PREV', icon: 'TW' },
  { id: 'h6', name: 'TechStars', role: 'Associate', year: 'PREV', icon: 'TS' },
  { id: 'h7', name: 'McKinsey & Company', role: 'Eng Mgr', year: 'PREV', icon: 'MC' },
  { id: 'h8', name: 'Penn Law', role: 'Juris Doctor', year: 'PREV', icon: 'PL' },
  { id: 'h9', name: 'Wharton School', role: 'Certificate of Business', year: 'PREV', icon: 'WH' },
  { id: 'h10', name: 'The College of NJ', role: 'Biology, Statistics', year: 'PREV', icon: 'CN' },
];

export const ADVISORY_HISTORY: CareerItem[] = [
  { id: 'a1', name: 'Decagon', role: 'Advisor', year: '2024', icon: 'DC' },
  { id: 'a2', name: 'WealthSimple', role: 'Advisor', year: '2023', icon: 'WS' },
  { id: 'a3', name: 'Oak HC/FT', role: 'Advisor', year: '2023', icon: 'OH' },
  { id: 'a4', name: 'Acrew Capital', role: 'Advisor', year: '2022', icon: 'AC' },
  { id: 'a5', name: 'Whatnot', role: 'Investor', year: '2022', icon: 'WN' },
  { id: 'a6', name: 'Headway', role: 'Investor', year: '2021', icon: 'HW' },
  { id: 'a7', name: 'CloudChef', role: 'Investor', year: '2021', icon: 'CC' },
  { id: 'a8', name: 'Various', role: 'Investor', year: '2021', icon: 'CC' },
];
