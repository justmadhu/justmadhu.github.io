    ...
    <div className="min-h-screen selection:bg-accent selection:text-white pb-12">
      ...
      <main className="relative max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 py-12 md:py-16">
        ...
        <header className="mb-16 md:mb-20 flex flex-col md:flex-row justify-between items-start gap-12">
          {/* Title Block (Left) - Top Aligned with no padding */}
          ...
          {/* Bio / Subtitle Block (Right) - Strictly Top Aligned */}
          ...
          <div className="space-y-8">
            <div className="flex flex-nowrap items-center gap-x-8 md:gap-x-12 overflow-x-auto pb-4 no-scrollbar">
              {CAREER_HISTORY.map((item) => (
                <div key={item.id} className="flex items-center gap-2.5 group flex-shrink-0">
                  <div className="w-8 h-8 flex items-center justify-center border rams-border bg-white group-hover:bg-accent group-hover:text-white group-hover:border-accent transition-all text-[9px] font-bold font-mono">
                    {item.icon}
                  </div>
            ...
            <div className="flex flex-nowrap items-center gap-x-8 md:gap-x-12 overflow-x-auto pb-4 no-scrollbar">
              {ADVISORY_HISTORY.map((item) => (
                <div key={item.id} className="flex items-center gap-2.5 group flex-shrink-0">
                  <div className="w-8 h-8 flex items-center justify-center border rams-border bg-white group-hover:bg-accent group-hover:text-white group-hover:border-accent transition-all text-[9px] font-bold font-mono opacity-60 group-hover:opacity-100">
                    {item.icon}
                  </div>
                  <div className="whitespace-nowrap">
